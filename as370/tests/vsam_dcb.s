...
* once the VSAM macros have been expanded first, which is why the
* defect
* needed a real module to surface: SYS1.MACLIB's MODCB/ACB/RPL exhaust
* the list of names known to be global, so IHB01's "&COMSW SETB 1" is
* no
...
*
* The order matters: MODCB before DCB is what fills the table.  All
* four
